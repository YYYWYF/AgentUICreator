...
import pluginDefinition5 from "./antd-x-conversations/definition";
import pluginDefinition6 from "./antd-x-prompts/definition";
import pluginDefinition7 from "./antd-x-resources/definition";
import pluginDefinition8 from "./antd-x-theme-provider/definition";
import pluginDefinition9 from "./antd-x-theme-switch/definition";
