...
export interface ConversationSubscribableAgent {
  subscribe(subscriber: AgentSubscriber): { unsubscribe(): void };
}

export class ConversationApplicationEventSource {
  private readonly listeners = new Set<AgentApplicationEventListener>();
  private unsubscribeFromAgent: (() => void) | undefined;

  constructor(private readonly agent: ConversationSubscribableAgent) {}
