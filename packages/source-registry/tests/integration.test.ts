...
import { loadAgentUISourceRegistry, parseSourceItem, resolveAgentUISourceItemClosure } from "../src/index.js";
...
describe("official integration resources", () => {
  ...
  it("shares dependency-first closure and leaves foundations free of optional integrations", async () => {
    ...
    expect(resolveAgentUISourceItemClosure(registry, "demo/frontend-tool-form").map(item => item.id)).toEqual(["foundation/core-runtime", "integration/react-hook-form", "demo/frontend-tool-form"]);
